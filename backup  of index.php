...
<!-- end #header-wrapper -->
<div id="logo">
	<h1><a href="#">e-Hire </a></h1>
	<p>Jobs for your choice </p>
		...
		<div id="page-bgtop">
			...
			<div id="content">
				<div class="post">
					...
					<p class="meta">Sunday, June 27, 2017 7:27 AM Posted by <a href="#">Someone</a></p>
					<div class="entry">
				...
				<div class="post">
					...
					<h2 class="title"><a href="#">Lorem ipsum sed aliquam</a></h2>
					<p class="meta">June,  27, 2017 7:27 AM Posted by <a href="#">Someone</a></p>
					<div class="entry">
...
<div id="footer-bgcontent">
	<div id="footer">
		<p>Copyright (c) 2017 e-Hire.com. All rights reserved. <br />
